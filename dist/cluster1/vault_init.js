...
console.log(wba_wallet_json_1.default);
// Create our keypair from the wallet file
...
const vaultAuth = web3_js_1.PublicKey.findProgramAddressSync([Buffer.from("auth"), vaultState.publicKey.toBuffer()], program.programId)[0];
